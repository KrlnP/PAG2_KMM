...
class Tool:
    ...
    def execute(self, parameters, messages):
        ...
        if path is None:
            ...
            arcpy.AddMessage(f"Path found. Writing to file...")
        ...
        #### Uncomment to add visited vertices to display
